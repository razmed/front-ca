  ...
  return (
    <div className="ProjectModal-overlay" onClick={handleOverlayClick}>
      <div className="ProjectModal-container">
        {/* Bouton de fermeture */}
        <button className="ProjectModal-close" onClick={onClose} aria-label="Fermer">
        ...
        <div className="ProjectModal-content">
          ...
          <div className="ProjectModal-info-grid">
            <div className="ProjectModal-info-item">
              <span className="ProjectModal-info-label">Catégorie</span>
              <span className="ProjectModal-info-value">
                {category ? category.nom : 'Non catégorisé'}
              </span>
            </div>
            <div className="ProjectModal-info-item">
              <span className="ProjectModal-info-label">Statut</span>
              <span className="ProjectModal-info-value">
                {project.status === 'completed' ? 'Projet terminé' : 'Projet en cours'}
              </span>
            </div>
            <div className="ProjectModal-info-item">
              <span className="ProjectModal-info-label">Localisation</span>
              <span className="ProjectModal-info-value">
                {project.location || 'Non spécifié'}
              </span>
            </div>
            <div className="ProjectModal-info-item">
              <span className="ProjectModal-info-label">Année</span>
              <span className="ProjectModal-info-value">
                {project.year || 'N/A'}
              </span>
            </div>
